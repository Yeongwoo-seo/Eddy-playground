...
const DevGameState = {
  ...
  // { [hotspotId]: {x1,y1,x2,y2} }. Backed by Supabase (AssetDB), not
  // localStorage — see the comment above AssetDB's roomHotspotsCache. Both
  // methods are now async; callers must await them.
