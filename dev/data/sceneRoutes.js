...
const MINIGAME_ROUTES = {
  'week0-scene-001-2-minigame': '/play/minigame-eastwood/',
  // [v08 재편] 서큘러키 사진+낚시 제안 (week0-scene-circular-quay 참고) —
  ...
  // 같은 계약).
  'week0-scene-circular-quay-minigame': '/play/minigame-fishing/',
  'week0-scene-002-2': '/play/minigame-phone-search/',
  'week0-scene-shop-visit': '/play/shop/',
  ...
  'week1-scene-003-exhibition-return': '/play/explore/?phase=W1_TOURISM&location=w1-adrian-spot',
  'week1-scene-004-minigame': '/play/minigame-photo-zoom/',
  'week1-scene-008-minigame': '/play/minigame-timeline/',
  ...
  'week1-suspect-hub-entry': '/play/explore/?phase=W1_SUSPECT_INTERVIEWS&location=w1-hub-plaza',
  'week1-suspect-interview-return': '/play/explore/?phase=W1_SUSPECT_INTERVIEWS&location=w1-hub-plaza',
  ...
  'week1-hub-entry-tourism': '/play/explore/?phase=W1_TOURISM&location=w1-circular-quay',
  // §12.8 — 재검증 단계 자유 순회.
  'week1-reverify-hub-entry': '/play/explore/?phase=W1_REVERIFICATION&location=w1-hub-plaza',
  'week1-reverify-interview-return': '/play/explore/?phase=W1_REVERIFICATION&location=w1-hub-plaza',
};
...
// chat. [v08 재편] The shop visit now returns into week0-scene-circular-quay
// (사진+낚시 제안, the very next beat in the new order) instead of the
// accommodation arrival, and the fishing minigame's own "돌아가기" now
// returns straight into week0-scene-002-1 (accommodation) since the shop
// beat already happened earlier in the day.
const SHOP_TUTORIAL_RETURN_SCENE = {
  'week0-scene-shop-visit': 'week0-scene-circular-quay',
  'week0-scene-circular-quay-minigame': 'week0-scene-002-1',
};
