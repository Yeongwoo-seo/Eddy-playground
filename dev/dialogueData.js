...
const week0SceneFlightLines = [
  ...
  { id: 'line-003', speaker: '', text: '지수가 비행기 모드를 해제하자\n영우의 메시지가 한꺼번에 들어왔다.', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-004', speaker: '영우', text: '착륙했어????', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-005', speaker: '영우', text: '나 B 출구 앞이야\n천천히 나와 ㅎㅎㅎㅎㅎㅎ', characterId: 'youngwoo', expression: 'soft' },
  { id: 'line-006', speaker: '지수', text: '오.\n이번엔 위치 설명 정확한데요????', characterId: 'jisoo', expression: 'smirk' },
  { id: 'line-007', speaker: '영우', text: '나 호주 살면서 성장했어.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-008', speaker: '지수', text: '아직 검증 전입니다\n서영우씨.', characterId: 'jisoo', expression: 'suspicious' },
  { id: 'line-009', speaker: '영우', text: '일단 착륙부터 하세요 손님 ㅋㅎㅋㅎㅋㅎㅋㅎ', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-010', speaker: '지수', text: '가고 있잖아요오!!!!\n지금 하늘인데 어케 빨리 가!!!!', characterId: 'jisoo', expression: 'annoyed' },
  { id: 'line-011', speaker: '', text: '지수는 웃으며 휴대폰을 내려놓았다.\n\n여행지가 가까워진다는 느낌보다,\n영우가 가까워진다는 느낌이 먼저 들었다.', characterId: 'jisoo', expression: 'soft' },
];
...
const week0Scene001Lines = [
  ...
  { id: 'line-003', speaker: '', text: '사람들 사이에서 영우가 손을 높이 흔들었다.', characterId: 'jisoo', expression: 'shocked' },
  { id: 'line-004', speaker: '지수', text: '영크크!!!!', characterId: 'jisoo', expression: 'happy' },
  { id: 'line-005', speaker: '영우', text: '지수지수야!!!!', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-006', speaker: '지수', text: '와...\n진짜 오랜만이다.', characterId: 'jisoo', expression: 'soft' },
  { id: 'line-007', speaker: '영우', text: '비행 괜찮았어?\n많이 피곤해 보이는데.', characterId: 'youngwoo', expression: 'soft' },
  { id: 'line-008', speaker: '지수', text: '피곤하긴 한데\n얼굴 보니까 좀 괜찮아졌어요.', characterId: 'jisoo', expression: 'soft' },
  { id: 'line-009', speaker: '영우', text: '가방도 줘.', characterId: 'youngwoo', expression: 'neutral' },
  { id: 'line-010', speaker: '지수', text: '이건 내가 들게.\n캐리어만 부탁해요.', characterId: 'jisoo', expression: 'smirk' },
  { id: 'line-011', speaker: '영우', text: '웅웅.\n천천히 가자.', characterId: 'youngwoo', expression: 'soft' },
  { id: 'line-012', speaker: '지수', text: '그래도 첫날이니까\n바로 숙소만 가면 안 돼요.', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-013', speaker: '영우', text: '그래서 잠깐 들를 데 있어.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-014', speaker: '', text: '영우가 자연스럽게 캐리어를 받아 들고,\n지수는 그 옆에 붙어 공항역 표지판을 따라갔다.', characterId: null },
  { id: 'line-015', speaker: '지수', text: '근데 우리 바로 숙소 가요?', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-016', speaker: '영우', text: '아니.\n첫날인데 시드니 봐야지.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-017', speaker: '지수', text: '헐.\n어디 가는데요????', characterId: 'jisoo', expression: 'shocked' },
  { id: 'line-018', speaker: '영우', text: '서큘러키.\n오페라하우스랑 하버브리지 보러.', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-019', speaker: '지수', text: '악 개쥬아아아!!!!', characterId: 'jisoo', expression: 'happy' },
  { id: 'line-020', speaker: '영우', text: '대신 길 찾기는 지수가 해야 돼.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-021', speaker: '지수', text: '왜 갑자기 조건이 붙어요????', characterId: 'jisoo', expression: 'annoyed' },
  { id: 'line-022', speaker: '영우', text: '김지수 시드니 생존교육 1교시.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-023', speaker: '지수', text: '오키.\n선생님 따라오세요.\n제가 모시겠습니다.', characterId: 'jisoo', expression: 'happy' },
];
...
const week0Scene002_1Lines = [
  ...
  { id: 'line-006', speaker: '영우', text: '옷 사려면\n앞으로 열심히 잡아야 합니다.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-007', speaker: '지수', text: '갑자기 압박 면접 시작.', characterId: 'jisoo', expression: 'smirk' },
  { id: 'line-008', speaker: '영우', text: '오늘 수익 68P.', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-009', speaker: '지수', text: '첫날 공동재산 생겼네.', characterId: 'jisoo', expression: 'happy' },
  { id: 'line-010', speaker: '영우', text: '지분은 반반.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-011', speaker: '지수', text: '제가 잡았는데 왜 반반이에요?', characterId: 'jisoo', expression: 'suspicious' },
  { id: 'line-012', speaker: '영우', text: '게임 만든 사람 지분.', characterId: 'youngwoo', expression: 'smirk' },
  { id: 'line-013', speaker: '지수', text: '음.\n그럼 저 7, 영우 3.', characterId: 'jisoo', expression: 'smirk' },
  { id: 'line-014', speaker: '영우', text: '시작부터 불공정 계약이잖아!!!!', characterId: 'youngwoo', expression: 'annoyed' },
  { id: 'line-015', speaker: '지수', text: 'ㅋㅎㅋㅎㅋㅎㅋㅎ\n이의 있으면 한 마리 더 잡아오세요.', characterId: 'jisoo', expression: 'happy' },
  { id: 'line-016', speaker: '영우', text: '오늘은 이만 쉽시다 사장님.', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-017', speaker: '지수', text: '웅.\n이제 좀 피곤하다.', characterId: 'jisoo', expression: 'blank' },
  { id: 'line-018', speaker: '영우', text: '여기야.', characterId: 'youngwoo', expression: 'neutral' },
  { id: 'line-019', speaker: '지수', text: '잠만.', characterId: 'jisoo', expression: 'suspicious' },
  { id: 'line-020', speaker: '지수', text: '진짜 여기 맞아요?', characterId: 'jisoo', expression: 'suspicious' },
  { id: 'line-021', speaker: '영우', text: '웅.\n왜?', characterId: 'youngwoo', expression: 'curious' },
  { id: 'line-022', speaker: '지수', text: '생각보다 너무 좋은데????', characterId: 'jisoo', expression: 'shocked' },
  { id: 'line-023', speaker: '영우', text: '그치.\n사진보다 괜찮지?', characterId: 'youngwoo', expression: 'happy' },
  { id: 'line-024', speaker: '지수', text: '흐으음.', characterId: 'jisoo', expression: 'suspicious' },
  { id: 'line-025', speaker: '영우', text: '그 표정 뭐야.', characterId: 'youngwoo', expression: 'curious' },
  { id: 'line-026', speaker: '지수', text: '영우가 고른 숙소치고\n너무 완벽해서요.', characterId: 'jisoo', expression: 'smirk' },
  { id: 'line-027', speaker: '영우', text: '아니 내가 평소에 뭘 어떻게 했길래!!!!', characterId: 'youngwoo', expression: 'annoyed' },
  { id: 'line-028', speaker: '지수', text: 'ㅋㅎㅋㅎㅋㅎㅋㅎ\n칭찬이에요 칭찬.', characterId: 'jisoo', expression: 'happy' },
  { id: 'line-029', speaker: '', text: '두 사람은 짐을 내려놓고\n잠시 방 안을 둘러봤다.', characterId: null },
  { id: 'line-030', speaker: '지수', text: '오늘 하루 진짜 알차게 놀았다.', characterId: 'jisoo', expression: 'soft' },
  { id: 'line-031', speaker: '영우', text: '그러게.\n근데 지수 진짜 피곤해 보이는데.', characterId: 'youngwoo', expression: 'soft' },
  { id: 'line-032', speaker: '지수', text: '조금?\n근데 아직 저녁도 안 먹었잖아.', characterId: 'jisoo', expression: 'blank' },
  { id: 'line-033', speaker: '영우', text: '아 맞다.\n일단 뭐 좀 먹으러 나갔다 오자.', characterId: 'youngwoo', expression: 'neutral' },
  { id: 'line-034', speaker: '지수', text: '웅.\n딱 가까운 데로만.', characterId: 'jisoo', expression: 'soft' },
];
...
const week0SceneChargerLines = [
  ...
  { id: 'line-007', speaker: '', text: '지수가 충전기를 꽂으려고\n가방을 뒤적였다.', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-008', speaker: '지수', text: '어?', characterId: 'jisoo', expression: 'blank' },
  { id: 'line-009', speaker: '영우', text: '왜?', characterId: 'youngwoo', expression: 'curious' },
  { id: 'line-010', speaker: '지수', text: '내 폰 어디 갔지????', characterId: 'jisoo', expression: 'shocked' },
  { id: 'line-011', speaker: '영우', text: '엉?\n아까 식당 나올 때까지는 들고 있었잖아.', characterId: 'youngwoo', expression: 'shocked' },
  { id: 'line-012', speaker: '지수', text: '그러니까.\n분명 있었는데.', characterId: 'jisoo', expression: 'shocked' },
  { id: 'line-013', speaker: '지수', text: '방 여기저기 다 뒤져봐야겠어요.', characterId: 'jisoo', expression: 'serious' },
  { id: 'line-014', speaker: '영우', text: '웅웅.\n같이 찾아보자.', characterId: 'youngwoo', expression: 'soft' },
  { id: 'line-015', speaker: '', text: '두 사람은 침대 밑, 서랍, 가방 속까지\n한참을 뒤졌지만 폰은 보이지 않았다.', characterId: null },
  { id: 'line-016', speaker: '지수', text: '아 진짜 어디 갔지.', characterId: 'jisoo', expression: 'annoyed' },
  { id: 'line-017', speaker: '영우', text: '내 폰으로 전화해볼게.\n소리라도 들리면 찾기 쉬울 거야.', characterId: 'youngwoo', expression: 'neutral' },
  { id: 'line-018', speaker: '', text: '영우가 지수의 번호로 전화를 걸었다.\n\n잠시 뒤,\n어디선가 희미한 진동음이 울렸다.', characterId: null },
  { id: 'line-019', speaker: '지수', text: '어?\n소리 저쪽에서 나는 것 같은데?', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-020', speaker: '영우', text: '부엌 쪽 아니야?', characterId: 'youngwoo', expression: 'curious' },
  { id: 'line-021', speaker: '지수', text: '어.\n맞는 것 같아요.', characterId: 'jisoo', expression: 'curious' },
  { id: 'line-022', speaker: '영우', text: '같이 가서 찾아보자.', characterId: 'youngwoo', expression: 'neutral' },
  { id: 'line-023', speaker: '', text: 'MINIGAME START', characterId: null },
];
